...
const TalentContract = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Talent Contract | EleveNoir Entertainment</title>
      </Helmet>
      <div
                ...
                >
                  ...
                  <div className="space-y-8 mb-8">
                    ...
                    <section>
                      ...
                      >
                        The Agency agrees to hire the Model, and the Model
                        agrees to provide services such as modeling, dancing, or
                        any other relevant services for the Agency, as requested
                        and agreed upon.
                      </p>
                    </section>
                    ...
                    <section>
                      ...
                      >
                        ...
                        Model shall not engage in any modeling, promotional
                        work, or other services for any other company, agency,
                        or individual without prior written consent from the
                        Agency's management.
                      </p>
                    </section>
                  </div>
                  ...
                  <form onSubmit={handleSubmitContract} className="space-y-6">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <label htmlFor="privacy-policy" className="text-sm">
                        By typing my signature above, I confirm that I am at
                        least 18 years old (( IC and OOC )), and I understand
                        that typing my name constitutes my electronic signature.
                        I agree that this electronic signature has the same
                        legal effect as a handwritten signature, and I am
