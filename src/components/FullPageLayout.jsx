...
import yua from "../assets/video/Yua.mp4";
import yua_picture from "../assets/images/yua_picture.png";
import lizzie_picture from "../assets/images/lizzie_picture.png";
import nala_picture from "../assets/images/nala_picture.png";
...
const FullPageLayout = () => {
  ...
  return (
    <>
      <Helmet>
        <title>EleveNoir Entertainment | Premium Adult Entertainment</title>
      </Helmet>
      <div
            ...
            <div className="container mx-auto px-4">
              ...
              >
                <h1 className="text-8xl font-cormorant font-bold mb-6 leading-none">
                  Elevate Your
                  <span className="block text-[#9C6B98] mt-2">
                    Entertainment
                  </span>
                </h1>
              ...
              <div className="col-span-12 md:col-span-5">
                ...
                >
                  ...
                  >
                    ...
                    services. Our team brings sophistication, allure and energy
                    to every occasion.
                  </p>
                  <Link
                    to="/book"
                ...
                <div className="grid grid-cols-2 gap-6">
                  {[
                    ...
                    },
                    {
                      ...
                      description:
                        "Exclusive performances for select gatherings",
                      icon: "💋",
                    },
                    {
        ...
        <section id="performers" className="py-32 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
              {[
                { name: "Yua", img: yua_picture },
                { name: "Lizzie", img: lizzie_picture },
                { name: "Nala", img: nala_picture },
              ].map((performer, index) => (
                <motion.div
                  key={performer.name}
